...
export default function Footer() {
    ...
    return (
        <footer className="text-gray-600 body-font px-5">
            ...
            <div className="text-[#A0A3A9] text-[16px] text-center pt-8 pb-16 flex flex-col gap-2 justify-center items-center">
                <div className="flex sm:flex-row flex-col gap-2">
                    <div>
                        ...
                        <a
                            ...
                            className="ml-1 underline text-gray-600 text-sm"
                            target="_blank"
                        >
                            Dliya’ Zarror Nibros
                        </a>
                    ...
                    <div>
                        Developed with ❤️ by
                        <a
                            href="https://github.com/hamzadevlpr"
                            rel="noopener noreferrer"
                            className="ml-1 underline text-gray-600 text-sm"
                            target="_blank"
                        >
                ...
                <p className="mt-2">©1999 - {new Date().getFullYear()} All rights reserved.</p>
            </div>
